...
- 🔭 I am currently working on [Intradr](www.intradr.netlify.app), a portfolio management website whose features will include the following when it is completed
...
- 🔭 I am currently working on [Xaenr](www.xaenr.netlify.app), a one-shot image recognition algorithm. It will be open for contribution soon. For now, you can checkout the progress [here](https://github.com/VinceXIV/open-image)
